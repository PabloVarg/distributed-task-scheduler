...
const (
	Scheduler_SendHeartbeat_FullMethodName   = "/grpc.Scheduler/SendHeartbeat"
	Scheduler_UpdateJobStatus_FullMethodName = "/grpc.Scheduler/UpdateJobStatus"
)
...
type SchedulerClient interface {
	SendHeartbeat(ctx context.Context, in *Heartbeat, opts ...grpc.CallOption) (*Ok, error)
	UpdateJobStatus(ctx context.Context, in *TaskStatus, opts ...grpc.CallOption) (*Ok, error)
}
...
func (c *schedulerClient) SendHeartbeat(ctx context.Context, in *Heartbeat, opts ...grpc.CallOption) (*Ok, error) {
...
func (c *schedulerClient) UpdateJobStatus(ctx context.Context, in *TaskStatus, opts ...grpc.CallOption) (*Ok, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ok)
...
type SchedulerServer interface {
	SendHeartbeat(context.Context, *Heartbeat) (*Ok, error)
	UpdateJobStatus(context.Context, *TaskStatus) (*Ok, error)
...
func (UnimplementedSchedulerServer) SendHeartbeat(context.Context, *Heartbeat) (*Ok, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendHeartbeat not implemented")
}
func (UnimplementedSchedulerServer) UpdateJobStatus(context.Context, *TaskStatus) (*Ok, error) {
...
func _Scheduler_SendHeartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchedulerServer).SendHeartbeat(ctx, req.(*Heartbeat))
	}
...
func _Scheduler_UpdateJobStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SchedulerServer).UpdateJobStatus(ctx, req.(*TaskStatus))
	}
	return interceptor(ctx, in, info, handler)
}
...
const (
	Worker_ExecuteJob_FullMethodName = "/grpc.Worker/ExecuteJob"
)
...
type WorkerClient interface {
	ExecuteJob(ctx context.Context, in *Task, opts ...grpc.CallOption) (*Ok, error)
}
...
func (c *workerClient) ExecuteJob(ctx context.Context, in *Task, opts ...grpc.CallOption) (*Ok, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Ok)
...
type WorkerServer interface {
	ExecuteJob(context.Context, *Task) (*Ok, error)
...
func (UnimplementedWorkerServer) ExecuteJob(context.Context, *Task) (*Ok, error) {
...
func _Worker_ExecuteJob_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkerServer).ExecuteJob(ctx, req.(*Task))
	}
	return interceptor(ctx, in, info, handler)
}
